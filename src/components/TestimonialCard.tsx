...
export const TestimonialCard: React.FC<TestimonialCardProps> = ({ 
  ...
  return (
    <div className="flex flex-col md:block">
      <div 
        className="p-4 md:p-8 rounded-lg transition-all duration-300 cursor-pointer group h-full flex flex-col"
      ...
      >
        ...
        {/* Testimonial Text */}
        <p className="text-white italic text-sm md:text-base leading-relaxed transition-colors duration-300 flex-grow">
          {quote}
        </p>
      </div>
