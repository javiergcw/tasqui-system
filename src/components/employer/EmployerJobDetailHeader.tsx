...
export const EmployerJobDetailHeader: React.FC = () => {
  return (
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap items-center gap-3 md:gap-4 lg:gap-6 mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className={colorClasses.text.gray600}>Wellesley Rd, London</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={colorClasses.text.gray600}>Accountancy</span>
            </div>
          ...
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: colors.primary[500] }}>
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
            </svg>
            <span className="text-sm font-medium" style={{ color: colors.primary[500] }}>
