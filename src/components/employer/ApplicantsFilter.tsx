...
export const ApplicantsFilter: React.FC<ApplicantsFilterProps> = ({ onFilterChange }) => {
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-gray-900 placeholder-gray-500"
            />
            <svg 
