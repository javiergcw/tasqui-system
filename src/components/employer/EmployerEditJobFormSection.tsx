...
export function EmployerEditJobFormSection() {
  // TODO: Cargar datos existentes del job basado en el ID
  const [formData, setFormData] = useState({
    jobTitle: 'Web Designer, Graphic Designer, UI/UX Designer',
    companyName: 'Tourt Design LTD',
    companyWebsite: 'www.tourtdesign.com',
    jobType: 'Full Time',
    salary: '$35000-$38000',
    jobCategory: 'Graphics Designer',
    companyEmail: 'hello@tourtdesign.com',
    location: 'Wellesley Rd, London',
    jobTags: 'web design, graphics design, video editing',
    experience: '2 years',
    jobDescription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.'
  });
