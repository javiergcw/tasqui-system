...
export const CompanyApplicantsSection: React.FC = () => {
  ...
  const handleApplicantClick = (applicantId: number) => {
    router.push(`/company/applicants/${applicantId}`);
  };
  ...
  const applicants = useMemo(() => [
    ...
    },
    {
      ...
      rating: 5,
      stage: 'hired',
      skills: ['Strategy', 'Management', 'Analytics'],
      social: {
        facebook: '#',
        twitter: '#',
        linkedin: '#'
  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Filter Section */}
        <ApplicantsFilter onFilterChange={handleFilterChange} />
