...
export const BlogRecentPostsCard: React.FC = () => {
  const recentPosts = [
    ...
    {
      id: 3,
      title: "El Crecimiento Económico está Aumentando gracias al Sector IT",
      image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80",
      date: "6 Feb, 2024"
    },
    {
      id: 4,
      title: "10 Cosas que Debes Saber Antes de Aplicar",
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm relative">
      ...
      <div className="flex items-center mb-4">
        <h3 className={`text-xl font-bold ${colorClasses.text.slate800}`}>Artículos Populares</h3>
      </div>
