// Exportar todos los casos de uso de employee

export { default as employeeRegisterUseCase } from './register.use-case';
export { default as employeeProfileUseCase } from './profile.use-case';
export { default as getEmployeeEducationsUseCase } from './get-educations.use-case';
